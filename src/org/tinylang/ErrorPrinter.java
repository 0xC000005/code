...
import org.tinylang.cli.TinyLangCmd;
...
public final class ErrorPrinter{
    ...
    public static void printFileNameAndLineNumber(Token offendingToken){
        reportError();
        System.err.print(TinyLangCmd.getFileName()+":"+offendingToken.getLine()+": ");
    ...
    @SuppressWarnings("rawtypes")
	public static void reportCyclicInheritance(Recognizer recognizer, TinyLangParser.ClassDeclarationContext ctx, Klass klass){
