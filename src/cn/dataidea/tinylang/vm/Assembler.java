...
public class Assembler {
	...
	public boolean use_indirect() {
		return use_indirect;
	}

	public void useIndirect(boolean flag) {
		use_indirect = flag;
	}
	...
	public void aconst(Label l) {
		gen("aconst", l);
	}

	public void pconst(Function f) {
		gen("pconst", f);
	}
	...
	public void indirectbr() {
		gen("indirectbr");
	} // unused

	public void indirectbrt() {
		gen("indirectbrt");
	} // unused

	public void indirectbrf() {
		gen("indirectbrf");
	} // unused
	...
	public void dynamic_gload() {
		gen("dgload");
	} // unused

	public void dynamic_fload() {
		gen("dfload");
	}

	public void dynamic_store() {
		gen("dstore");
	} // unused

	public void dynamic_gstore() {
		gen("gstore");
	} // unused

	public void dynamic_fstore() {
		gen("fstore");
	} // unused

	public void dynamic_alloca() {
		gen("dalloca");
	} // unused
	// @formatter:on
